        ...
        for h in range(n_H_prev):                           # loop over vertical axis of the output volume
            for w in range(n_W_prev):                       # loop over horizontal axis of the output volume
                for c in range(n_C):                   # loop over channels (= #filters) of the output volume
                    ...
                    if (horiz_end > m):
                        break
                    #print(i,h,w,c,vert_start,vert_end,horiz_start,horiz_end)
...
#A_prev = np.random.randn(10,10,10,3)
...
def pool_forward(A_prev, hparameters, mode = "max"):
    ...
    #print(m, n_H, n_W, n_C, n_H_prev, n_W_prev, n_C_prev)
    ### START CODE HERE ###
        ...
        for h in range(n_H):                     # loop on the vertical axis of the output volume
            for w in range(n_W):                 # loop on the horizontal axis of the output volume
                for c in range (n_C):            # loop over the channels of the output volume
                    ...
                    if (horiz_end > n_W_prev):
                        break
                    if (vert_end  > n_H_prev):
                        break
                    # Use the corners to define the current slice on the ith training example of A_prev, channel c. (≈1 line)
                    a_prev_slice = A_prev[i,vert_start:vert_end,horiz_start:horiz_end,c]
                    #print(np.shape(a_prev_slice))
